      ...
      <div className="absolute inset-0 bg-gradient-to-r from-black/80 via-black/40 to-transparent flex items-center">
        <div className="px-6 md:px-16 w-full max-w-2xl">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-7xl font-black text-white leading-tight mb-4 tracking-tighter">
            Giải Cứu Làn Da <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-400 to-yellow-300">Mùa Hanh Khô</span>
          </h2>
          <p className="text-gray-200 text-sm md:text-lg mb-8 max-w-md font-medium">
            Khám phá bộ sưu tập kem dưỡng ẩm siêu phục hồi từ các thương hiệu dược mỹ phẩm hàng đầu. Giảm ngay đến 40%.
          </p>
