import { Copy, Clock, Star, Info } from 'lucide-react';
...
export const VoucherCard = ({ coupon, isComingSoon, isExpiringSoon }: VoucherCardProps) => {
  const handleCopy = () => {
  ...
  return (
    <div className="relative group overflow-hidden">
      ...
      <div className="flex bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-xl hover:border-primary-100 transition-all duration-500 overflow-hidden min-h-[140px]">
        
        {/* Left Side: Discount Value */}
        <div className={clsx(
          "w-1/3 flex flex-col items-center justify-center p-4 relative overflow-hidden",
          isComingSoon ? "bg-slate-100 text-slate-400" : "bg-primary-500 text-white"
        )}>
